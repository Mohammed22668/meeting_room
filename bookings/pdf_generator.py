...
def register_arabic_font():
    try:
        ...
        # إضافة STATIC_ROOT إذا كان موجوداً
        if hasattr(settings, 'STATIC_ROOT') and settings.STATIC_ROOT:
            font_paths.append(os.path.join(settings.STATIC_ROOT, 'fonts', 'Cairo-Regular.ttf'))
...
def create_booking_pdf(booking):
    ...
    filepath = os.path.join(media_root, 'pdfs', filename)
